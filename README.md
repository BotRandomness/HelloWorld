...
3. Then git push to your repository
4. Open a Pull Request in this repositroy, where your changes will be look at to be approved
5. Once it's approved, it will be in a development branch, soon to be merge to the master branch
